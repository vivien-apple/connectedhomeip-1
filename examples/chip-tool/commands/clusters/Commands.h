...
public:
    ...
    uint16_t EncodeCommand(const PacketBufferHandle & buffer, uint16_t bufferSize, uint8_t endPointId) override
    {
        return encodeColorControlClusterReportCurrentXAttribute(buffer->Start(), bufferSize, endPointId, mMinInterval,
                                                                mMaxInterval);
    }
...
public:
    ...
    uint16_t EncodeCommand(const PacketBufferHandle & buffer, uint16_t bufferSize, uint8_t endPointId) override
    {
        return encodeColorControlClusterReportCurrentYAttribute(buffer->Start(), bufferSize, endPointId, mMinInterval,
                                                                mMaxInterval);
    }
...
void registerClusterIasZone(Commands & commands)
{
    ...
    commands_list clusterCommands = {
        ...
        make_unique<ReadIasZoneZoneStatus>(),     make_unique<ReadIasZoneIasCieAddress>(), make_unique<ReadIasZoneZoneID>(),
    };

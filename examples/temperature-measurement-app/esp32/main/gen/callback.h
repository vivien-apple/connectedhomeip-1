...
// Cluster Basic
void emberAfBasicClusterInitCallback(CHIPEndpointId endpoint);
void emberAfBasicClusterServerInitCallback(CHIPEndpointId endpoint);
void emberAfBasicClusterServerTickCallback(CHIPEndpointId endpoint);
// Cluster Temperature Measurement
void emberAfTemperatureMeasurementClusterInitCallback(CHIPEndpointId endpoint);
void emberAfTemperatureMeasurementClusterServerInitCallback(CHIPEndpointId endpoint);
void emberAfTemperatureMeasurementClusterServerTickCallback(CHIPEndpointId endpoint);
 ...
 */
bool emberAfClusterSecurityCustomCallback(EmberAfProfileId profileId, CHIPClusterId clusterId, bool incoming,
 ...
 * not.  Ver.: always
 */
bool emberAfDiscoverAttributesResponseCallback(CHIPClusterId clusterId, bool discoveryComplete, uint8_t * buffer, uint16_t bufLen,
                                               bool extended);
 ...
 */
bool emberAfGetEndpointInfoCallback(CHIPEndpointId endpoint, uint8_t * returnNetworkIndex,

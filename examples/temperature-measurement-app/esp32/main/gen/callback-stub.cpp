...
void __attribute__((weak)) emberAfBasicClusterInitCallback(CHIPEndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}
void __attribute__((weak)) emberAfTemperatureMeasurementClusterInitCallback(CHIPEndpointId endpoint)
{
    // To prevent warning
    (void) endpoint;
}

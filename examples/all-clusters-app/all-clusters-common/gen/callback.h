...
bool emberAfBindingClusterBindCallback(uint64_t nodeId, uint16_t groupId, uint8_t endpointId, chip::ClusterId clusterId);
...
bool emberAfBindingClusterUnbindCallback(uint64_t nodeId, uint16_t groupId, uint8_t endpointId, chip::ClusterId clusterId);

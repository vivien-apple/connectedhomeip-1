...
bool emberAfScenesClusterGetSceneMembershipResponseCallback(EmberAfStatus status, uint8_t capacity, uint16_t groupId,
...
bool emberAfScenesClusterViewSceneResponseCallback(EmberAfStatus status, uint16_t groupId, uint8_t sceneId, uint16_t transitionTime,

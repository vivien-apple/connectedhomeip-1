...
bool __attribute__((weak))
emberAfGroupsClusterGetGroupMembershipResponseCallback(uint8_t capacity, uint8_t groupCount, uint16_t groupList)
{
    // To prevent warning
    (void) capacity;
    (void) groupCount;
...
bool __attribute__((weak))
emberAfGroupsClusterViewGroupResponseCallback(EmberAfStatus status, uint16_t groupId, uint8_t * groupName)
{
    // To prevent warning
    (void) status;
    (void) groupId;
...
bool __attribute__((weak)) emberAfIASZoneClusterZoneStatusChangeNotificationCallback(uint16_t zoneStatus, uint8_t extendedStatus,
...
bool __attribute__((weak))
emberAfScenesClusterGetSceneMembershipResponseCallback(EmberAfStatus status, uint8_t capacity, uint16_t groupId, uint8_t sceneCount,
                                                       uint8_t sceneList)
{
    // To prevent warning
    (void) status;
...
bool __attribute__((weak))
emberAfScenesClusterViewSceneResponseCallback(EmberAfStatus status, uint16_t groupId, uint8_t sceneId, uint16_t transitionTime,
                                              uint8_t * sceneName, EmberAfSceneExtensionFieldSet extensionFieldSets)
{
    // To prevent warning
    (void) status;
    (void) groupId;

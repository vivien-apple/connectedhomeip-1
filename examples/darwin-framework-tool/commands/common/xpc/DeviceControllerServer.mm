...
+ (void)load
{
    __auto_type * instance = [[DeviceControllerXPCServer alloc] init];
    [[XPCServerRegistry sharedInstance] register:instance];
}
...
+ (void)load
{
    __auto_type * instance = [[DeviceControllerXPCServerWithServiceName alloc] init];
    [[XPCServerRegistry sharedInstance] register:instance];
}

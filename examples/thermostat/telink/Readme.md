...
| Effect                          | Description                                                                   |
| :------------------------------ | :---------------------------------------------------------------------------- |
| Blinks (200 ms on/200 ms off)   | Blink (Clusters::Identify::IdentifyEffectIdentifier::kBlink)                  |
| Breathe (during 1000 ms)        | Breathe (Clusters::Identify::IdentifyEffectIdentifier::kBreathe)              |
| Blinks (50 ms on/950 ms off)    | Okay (Clusters::Identify::IdentifyEffectIdentifier::kOkay)                    |
| Blinks (1000 ms on/1000 ms off) | Channel Change (Clusters::Identify::IdentifyEffectIdentifier::kChannelChange) |
| Blinks (950 ms on/50 ms off)    | Finish (Clusters::Identify::IdentifyEffectIdentifier::kFinishEffect)          |
| LED off                         | Stop (Clusters::Identify::IdentifyEffectIdentifier::kStopEffect)              |

...
CHIP_ERROR DispatchServerCommand(CommandHandler * handler, const ConcreteCommandPath & path, TLV::TLVReader & tlvData)
{
    ...
    case Commands::InstantAction::Id: {
        ...
        VerifyOrReturnError(emberAfActionsClusterInstantActionCallback(handler, path, data), CHIP_ERROR_INTERNAL);
        break;
    }
    default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::Actions::Id:
        err = Clusters::Actions::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;

...
public:
    ...
    CHIP_ERROR UpdateFabricLabel(Callback::Cancelable * onSuccessCallback, Callback::Cancelable * onFailureCallback,
                                 chip::ByteSpan label);
    CHIP_ERROR UpdateOpCert(Callback::Cancelable * onSuccessCallback, Callback::Cancelable * onFailureCallback, chip::ByteSpan noc,
...
private:
    ...
    static constexpr CommandId kUpdateOpCertCommandId      = 0x07;
};

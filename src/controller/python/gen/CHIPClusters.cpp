...
CHIP_ERROR OperationalCredentialsCluster::UpdateOpCert(Callback::Cancelable * onSuccessCallback,
                                                       Callback::Cancelable * onFailureCallback, chip::ByteSpan noc,
                                                       chip::ByteSpan iCACertificate)
{
    ...
    app::CommandPathParams cmdParams = { mEndpoint, /* group id */ 0, mClusterId, kUpdateOpCertCommandId,
                                         (chip::app::CommandPathFlags::kEndpointIdValid) };
    app::Command * ZCLcommand        = mDevice->GetCommandSender();
    ...
    uint8_t seqNum = mDevice->GetNextSequenceNumber();
    System::PacketBufferHandle encodedCommand =
        encodeOperationalCredentialsClusterUpdateOpCertCommand(seqNum, mEndpoint, noc, iCACertificate);
    return SendCommand(seqNum, std::move(encodedCommand), onSuccessCallback, onFailureCallback);
#endif
}

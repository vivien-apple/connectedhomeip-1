...
public:
    ...
    // Cluster Commands
    CHIP_ERROR Bind(Callback::Callback<> * onCompletion, uint64_t nodeId, uint16_t groupId, uint8_t endpointId,
                    chip::ClusterId clusterId);
    CHIP_ERROR Unbind(Callback::Callback<> * onCompletion, uint64_t nodeId, uint16_t groupId, uint8_t endpointId,
                      chip::ClusterId clusterId);

    // Cluster Attributes
    CHIP_ERROR DiscoverAttributes(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReadAttributeBindingsCount(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReadAttributeClusterRevision(Callback::Callback<> * onCompletion);
};
...
public:
    ...
    CHIP_ERROR ReportAttributeCurrentHue(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                         uint8_t change, Callback::Callback<> * onChange);
    CHIP_ERROR ReportAttributeCurrentSaturation(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                                uint8_t change, Callback::Callback<> * onChange);
    CHIP_ERROR ReportAttributeCurrentX(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                       uint16_t change, Callback::Callback<> * onChange);
    CHIP_ERROR ReportAttributeCurrentY(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                       uint16_t change, Callback::Callback<> * onChange);
    CHIP_ERROR ReportAttributeColorTemperature(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                               uint16_t change, Callback::Callback<> * onChange);
};
...
public:
    ...
    CHIP_ERROR ReadAttributeClusterRevision(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReportAttributeLockState(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
...
public:
    ...
    CHIP_ERROR ReadAttributeClusterRevision(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReportAttributeCurrentLevel(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                           uint8_t change, Callback::Callback<> * onChange);
};
...
public:
    ...
    CHIP_ERROR ReadAttributeClusterRevision(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReportAttributeOnOff(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                    Callback::Callback<> * onChange);
};
...
public:
    ...
    CHIP_ERROR ReadAttributeClusterRevision(Callback::Callback<> * onCompletion);
    CHIP_ERROR ReportAttributeMeasuredValue(Callback::Callback<> * onCompletion, uint16_t minInterval, uint16_t maxInterval,
                                            int16_t change, Callback::Callback<> * onChange);
};

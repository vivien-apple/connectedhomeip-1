...
logger = logging.getLogger('CHIPLevelControlTest')
...
class TestLevelControlCluster(CHIPVirtualHome):
    ...
    def run_data_model_test(self):
        ...
        commands['move'] = "0 0 0 0"
        commands['move-with-on-off'] = "0 0 0 0"
        commands['move-to-level'] = "0 0 0 0"
        commands['move-to-level-with-on-off'] = "0 0 0 0"
        commands['step'] = "0 0 0 0 0"
        commands['step-with-on-off'] = "0 0 0 0 0"
        commands['stop'] = "0 0"
        commands['stop-with-on-off'] = "0 0"

        command = "chip-tool level {} {} {} {} 1"
...
if __name__ == "__main__":
    sys.exit(TestLevelControlCluster(DEVICE_CONFIG).run_test())

...
logger = logging.getLogger('CHIPIdentifyTest')
...
class TestIdentifyCluster(CHIPVirtualHome):
    ...
    def run_data_model_test(self):
        ...
        commands['identify'] = "0"
        commands['identify-query'] = ""

        command = "chip-tool identify {} {} {} {} 1"
...
if __name__ == "__main__":
    sys.exit(TestIdentifyCluster(DEVICE_CONFIG).run_test())

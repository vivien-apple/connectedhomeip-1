...
logger = logging.getLogger('CHIPScenesTest')
...
class TestScenesCluster(CHIPVirtualHome):
    ...
    def run_data_model_test(self):
        ...
        commands['add-scene'] = "0 0 0 0 0 0"
        commands['get-scene-membership'] = "0"
        commands['recall-scene'] = "0 0 0"
        commands['remove-all-scenes'] = "0"
        commands['remove-scene'] = "0 0"
        commands['store-scene'] = "0 0"
        commands['view-scene'] = "0 0"

        command = "chip-tool scenes {} {} {} {} 1"
...
if __name__ == "__main__":
    sys.exit(TestScenesCluster(DEVICE_CONFIG).run_test())

...
logger = logging.getLogger('CHIPColorControlTest')
...
class TestColorControlCluster(CHIPVirtualHome):
    ...
    def run_data_model_test(self):
        ...
        commands['move-color'] = "0 0 0 0"
        commands['move-color-temperature'] = "0 0 0 0 0 0"
        commands['move-hue'] = "0 0 0 0"
        commands['move-saturation'] = "0 0 0 0"
        commands['move-to-color'] = "0 0 0 0 0"
        commands['move-to-color-temperature'] = "0 0 0 0"
        commands['move-to-hue'] = "0 0 0 0 0"
        commands['move-to-hue-and-saturation'] = "0 0 0 0 0"
        commands['move-to-saturation'] = "0 0 0 0"
        commands['step-color'] = "0 0 0 0 0"
        commands['step-color-temperature'] = "0 0 0 0 0 0 0"
        commands['step-hue'] = "0 0 0 0 0"
        commands['step-saturation'] = "0 0 0 0 0"
        commands['stop-move-step'] = "0 0"

        command = "chip-tool colorcontrol {} {} {} {} 1"
...
if __name__ == "__main__":
    sys.exit(TestColorControlCluster(DEVICE_CONFIG).run_test())

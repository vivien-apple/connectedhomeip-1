...
logger = logging.getLogger('CHIPGroupsTest')
...
class TestGroupsCluster(CHIPVirtualHome):
    ...
    def run_data_model_test(self):
        ...
        commands['add-group'] = "0 0"
        commands['add-group-if-identifying'] = "0 0"
        commands['get-group-membership'] = "0 0"
        commands['remove-all-groups'] = ""
        commands['remove-group'] = "0"
        commands['view-group'] = "0"

        command = "chip-tool groups {} {} {} {} 1"
...
if __name__ == "__main__":
    sys.exit(TestGroupsCluster(DEVICE_CONFIG).run_test())

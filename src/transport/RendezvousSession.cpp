...
CHIP_ERROR RendezvousSession::WaitForPairing(Optional<NodeId> nodeId, uint32_t setupPINCode)
{
    ...
    return mPairingSession.WaitForPairing(setupPINCode, kSpake2p_Iteration_Count, Uint8::from_const_char(kSpake2pKeyExchangeSalt),
...
{
    mPairingInProgress = true;
    return mPairingSession.Pair(setupPINCode, kSpake2p_Iteration_Count, Uint8::from_const_char(kSpake2pKeyExchangeSalt),

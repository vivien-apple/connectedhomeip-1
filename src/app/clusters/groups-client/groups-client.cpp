...
bool emberAfGroupsClusterAddGroupResponseCallback(EmberAfStatus status, GroupId groupId)
{
...
bool emberAfGroupsClusterViewGroupResponseCallback(EmberAfStatus status, GroupId groupId, uint8_t * groupName)
{
...
bool emberAfGroupsClusterRemoveGroupResponseCallback(EmberAfStatus status, GroupId groupId)
{

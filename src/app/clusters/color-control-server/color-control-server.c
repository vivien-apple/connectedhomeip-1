                                                              ...
                                                              uint8_t optionsMask, uint8_t optionsOverride)
{
    ...
    emberAfEventControlSetDelayMS(&COLOR_HSV_CONTROL, UPDATE_TIME_MS);
                                                   ...
                                                   uint8_t optionsOverride)
{
    ...
    // kick off the state machine:
    emberAfEventControlSetDelayMS(&COLOR_XY_CONTROL, UPDATE_TIME_MS);
...
static void moveToColorTemp(uint8_t endpoint, uint16_t colorTemperature, uint16_t transitionTime)
{
    ...
    // kick off the state machine:
    emberAfEventControlSetDelayMS(&COLOR_TEMP_CONTROL, UPDATE_TIME_MS);
}

                                                            ...
                                                            uint16_t min_interval, uint16_t max_interval)
{
    ...
    REPORT_ATTRIBUTE("ReportColorControlCurrentHue", COLOR_CONTROL_CLUSTER_ID, false, 0);
}
                                                                   ...
                                                                   uint16_t max_interval)
{
    ...
    uint8_t attr_type = { 0x20 };
    REPORT_ATTRIBUTE("ReportColorControlCurrentSaturation", COLOR_CONTROL_CLUSTER_ID, false, 0);
}
                                                          ...
                                                          uint16_t min_interval, uint16_t max_interval)
{
    ...
    REPORT_ATTRIBUTE("ReportColorControlCurrentX", COLOR_CONTROL_CLUSTER_ID, false, 0);
}
                                                          ...
                                                          uint16_t min_interval, uint16_t max_interval)
{
    ...
    uint8_t attr_type = { 0x21 };
    REPORT_ATTRIBUTE("ReportColorControlCurrentY", COLOR_CONTROL_CLUSTER_ID, false, 0);
}
                                                                  ...
                                                                  uint16_t max_interval)
{
    ...
    uint8_t attr_type = { 0x21 };
    REPORT_ATTRIBUTE("ReportColorControlColorTemperature", COLOR_CONTROL_CLUSTER_ID, false, 0);
}
                                                              ...
                                                              uint16_t max_interval)
{
    uint16_t attr_id  = 0x0000;
    uint8_t attr_type = { 0x20 };
    REPORT_ATTRIBUTE("ReportLevelControlCurrentLevel", LEVEL_CONTROL_CLUSTER_ID, false, 0);
}
                                                                         ...
                                                                         uint16_t max_interval)
{
    ...
    REPORT_ATTRIBUTE("ReportTemperatureMeasurementMeasuredValue", TEMPERATURE_MEASUREMENT_CLUSTER_ID, false, 0);
}
...
{
    uint16_t attr_ids[] = { 0xFFFD };
    READ_ATTRIBUTES("ReadTemperatureMeasurementClusterRevision", TEMPERATURE_MEASUREMENT_CLUSTER_ID);
}

...
const kDefaultResponse = {
  arguments : [
    { name : 'hostName', type : 'CHAR_STRING' }, { name : 'instanceName', type : 'CHAR_STRING' },
    { name : 'longDiscriminator', type : 'INT16U', chipType : 'uint16_t' },
    { name : 'vendorId', type : 'INT16U', chipType : 'uint16_t' }, { name : 'productId', type : 'INT16U', chipType : 'uint16_t' },
    ...
    { name : 'deviceName', type : 'CHAT_STRING' }, { name : 'rotatingIdLen', type : 'INT64U', chipType : 'size_t' },
    { name : 'pairingHint', type : 'INT16U', chipType : 'uint16_t' }, { name : 'pairingInstruction', type : 'CHAR_STRING' },
    { name : 'numIPs', type : 'INT32U', chipType : 'int' }
  ]
};

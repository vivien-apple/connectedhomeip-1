...
- (void)reportFromUserEnteredSettings
{
    ...
    [self.cluster configureAttributeMeasuredValue: minIntervalSeconds maxInterval:maxIntervalSeconds change:deltaInFahrenheit completionHandler:^(NSError *error, NSDictionary *values) {
        if (error == nil) return;

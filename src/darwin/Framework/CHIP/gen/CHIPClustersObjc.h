...
typedef void (^DoorLockClusterClearAllPinsResponseHandler)();
typedef void (^DoorLockClusterClearAllRfidsResponseHandler)();
typedef void (^DoorLockClusterClearHolidayScheduleResponseHandler)();
typedef void (^DoorLockClusterClearPinResponseHandler)();
typedef void (^DoorLockClusterClearRfidResponseHandler)();
typedef void (^DoorLockClusterClearWeekdayScheduleResponseHandler)();
typedef void (^DoorLockClusterClearYeardayScheduleResponseHandler)();
typedef void (^DoorLockClusterGetHolidayScheduleResponseHandler)(
    uint8_t scheduleId, uint32_t localStartTime, uint32_t localEndTime, uint8_t operatingModeDuringHoliday);
typedef void (^DoorLockClusterGetLogRecordResponseHandler)(uint16_t logEntryId, uint32_t timestamp, uint8_t eventType,
    uint8_t source, uint8_t eventIdOrAlarmCode, uint16_t userId, uint8_t * pin);
typedef void (^DoorLockClusterGetPinResponseHandler)(uint16_t userId, uint8_t userStatus, uint8_t userType, uint8_t * pin);
typedef void (^DoorLockClusterGetRfidResponseHandler)(uint16_t userId, uint8_t userStatus, uint8_t userType, uint8_t * rfid);
typedef void (^DoorLockClusterGetUserTypeResponseHandler)(uint16_t userId, uint8_t userType);
typedef void (^DoorLockClusterGetWeekdayScheduleResponseHandler)(uint8_t scheduleId, uint16_t userId, uint8_t daysMask,
    uint8_t startHour, uint8_t startMinute, uint8_t endHour, uint8_t endMinute);
typedef void (^DoorLockClusterGetYeardayScheduleResponseHandler)(
    uint8_t scheduleId, uint16_t userId, uint32_t localStartTime, uint32_t localEndTime);
typedef void (^DoorLockClusterLockDoorResponseHandler)();
typedef void (^DoorLockClusterSetHolidayScheduleResponseHandler)();
typedef void (^DoorLockClusterSetPinResponseHandler)();
typedef void (^DoorLockClusterSetRfidResponseHandler)();
typedef void (^DoorLockClusterSetUserTypeResponseHandler)();
typedef void (^DoorLockClusterSetWeekdayScheduleResponseHandler)();
typedef void (^DoorLockClusterSetYeardayScheduleResponseHandler)();
typedef void (^DoorLockClusterUnlockDoorResponseHandler)();
typedef void (^DoorLockClusterUnlockWithTimeoutResponseHandler)();
typedef void (^GroupsClusterAddGroupResponseHandler)(uint16_t groupId);
typedef void (^GroupsClusterGetGroupMembershipResponseHandler)(
    uint8_t capacity, uint8_t groupCount, /* TYPE WARNING: array array defaults to */ uint8_t * groupList);
typedef void (^GroupsClusterRemoveGroupResponseHandler)(uint16_t groupId);
typedef void (^GroupsClusterViewGroupResponseHandler)(uint16_t groupId, uint8_t * groupName);
typedef void (^IdentifyClusterIdentifyQueryResponseHandler)(uint16_t timeout);
typedef void (^ScenesClusterAddSceneResponseHandler)(uint16_t groupId, uint8_t sceneId);
typedef void (^ScenesClusterGetSceneMembershipResponseHandler)(
    uint8_t capacity, uint16_t groupId, uint8_t sceneCount, /* TYPE WARNING: array array defaults to */ uint8_t * sceneList);
typedef void (^ScenesClusterRemoveAllScenesResponseHandler)(uint16_t groupId);
typedef void (^ScenesClusterRemoveSceneResponseHandler)(uint16_t groupId, uint8_t sceneId);
typedef void (^ScenesClusterStoreSceneResponseHandler)(uint16_t groupId, uint8_t sceneId);
typedef void (^ScenesClusterViewSceneResponseHandler)(uint16_t groupId, uint8_t sceneId, uint16_t transitionTime,
